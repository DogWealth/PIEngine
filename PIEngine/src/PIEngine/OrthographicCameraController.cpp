...
namespace PIEngine {
	...
	void OrthographicCameraController::OnEvent(Event& e)
	{
		...
		dispatcher.Dispatch<MouseScrolledEvent>(PI_BIND_EVENT_FN(OrthographicCameraController::OnMouseScrolled));
		dispatcher.Dispatch<WindowResizeEvent>(PI_BIND_EVENT_FN(OrthographicCameraController::OnWindowResized));
	}
